...
# 4. python RelayToPeerJitter.py <a|b> <size of packets in bytes> <duration of measurement in seconds>
# 5. Example: python RelayToPeerJitter.py a 100 1, means: login as user 'a', send 100 byte packets for 1 second to 'b'
# 6. Example: python RelayToPeerJitter.py b 0 0, means: login as user 'b', receive packets from 'a', send back results
